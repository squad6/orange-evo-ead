...
@endif
{{-- {{ dd($module) }} --}}
<form action="{{ route('admin.module.update', ['trail' => $trail, 'module' => $module]) }}" method="POST">
    @csrf
...
<form action="{{ route('admin.module.destroy', ['trail' => $trail->id, 'module' => $module->id]) }}" method="POST">
    @csrf
