                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <form class="user" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                <label for="birth_date" class="col-md-4 col-form-label text-md-end">{{ __('Aniversário:') }}</label>
                                <input type="date" class="form-control form-control-user @error('birth_date') is-invalid @enderror" id="birth_date" name="birth_date"
